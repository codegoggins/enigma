...
const Card = (blog) => {
  return (
    ...
    <div className='min-w-[21rem] p-1 py-6 cursor-pointer'>
        ...
        <h1 className='text-[1.6rem] font-[700] leading-[1.9rem] text-blackPrimary hover:underline cursor-pointer'>{blog?.blog?.title}</h1>
